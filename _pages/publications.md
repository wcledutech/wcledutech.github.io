...
title: "Publications"
excerpt: "Publications by Chengliang Wang in educational technology, generative AI, programming education, human-computer interaction and learning analytics."
author_profile: true
---
...
<section class="publication-hero">
  ...
  <div class="publication-metrics" aria-label="Publication overview">
    ...
    <div class="publication-metric"><strong>18</strong><span>ESI 1% highly cited papers</span></div>
...
- Wang, H. M.#, **Wang, C. L.**#, Xu, H. X., Bao, C. J., & Xu, X. L.\* (2026). Enhancing real-time facial emotion recognition in classrooms via Attention-ResNet optimization. *The Visual Computer, 42*(1), Article 46. [https://doi.org/10.1007/s00371-025-04265-1](https://doi.org/10.1007/s00371-025-04265-1)
...
- Ling, X., & **Wang, C. L.**\* (2026). Bibliometric mapping and evolutionary logic of large language models reshaping medical education 2022-2026. *Discover Computing, 29*(1), Article 543. [https://doi.org/10.1007/s10791-026-10445-x](https://doi.org/10.1007/s10791-026-10445-x)
- Yang, J. W., Wang, H. M., Chen, M. Y., Chen, X. J., Wang, J. Y., & **Wang, C. L.**\* (2026). Configurational pathways of programming learning beliefs and self-efficacy among college students using intelligent agents: Evidence from GenAI literacy and agent usage experience. *Interactive Learning Environments*, 1-33. [https://doi.org/10.1080/10494820.2026.2713873](https://doi.org/10.1080/10494820.2026.2713873)
- Ling, X., & **Wang, C. L.**\* (2026). Research landscape thematic evolution and future trends of artificial intelligence in medical education from 2015 to 2025. *Discover Computing, 29*(1), Article 447. [https://doi.org/10.1007/s10791-026-10349-w](https://doi.org/10.1007/s10791-026-10349-w)
- Xiao, Z. H., Wang, H. M.\*, Jin, S., Lai, Y. T., Cao, Y., Zhang, Y. X., & **Wang, C. L.**\* (2026). Human-AI collaborative learning ecosystem: Effects of multi-agent-based programming learning on learning outcomes, computational thinking, and behavioral patterns in higher education. *International Journal of Human-Computer Interaction*, 1-22. [https://doi.org/10.1080/10447318.2026.2692021](https://doi.org/10.1080/10447318.2026.2692021)
- Liu, X. C., Tang, Q. W., Wu, W. T., Chen, X. J., & **Wang, C. L.**\* (2026). GenAI-agents in education: A systematic review of macro-level trends, educational roles, theoretical foundations and future agendas. *Interactive Learning Environments*, 1-23. [https://doi.org/10.1080/10494820.2026.2672562](https://doi.org/10.1080/10494820.2026.2672562)
...
- Wang, J. Y., Wang, H. M., Yang, J. W.\*, & **Wang, C. L.**\* (2026). Academic transformation in the era of artificial intelligence: Drivers of university faculty adoption of GenAI based on the UTAUT model. *Humanities and Social Sciences Communications, 13*(1), Article 1268. [https://doi.org/10.1057/s41599-026-07606-0](https://doi.org/10.1057/s41599-026-07606-0) (SSCI Q1; AHCI)
...
- Yu, T., Zeng, Z. K., Liu, T., & **Wang, C. L.** (2026). Virtual streamers, real purchases: The roles of anthropomorphism, interactivity, and presence in e-commerce live streaming. *International Journal of Contemporary Hospitality Management, 38*(13), 239-263. [https://doi.org/10.1108/IJCHM-02-2026-0155](https://doi.org/10.1108/IJCHM-02-2026-0155)
- Xu, J., Luo, Y. Y.\*, **Wang, C. L.**, & Wu, H. N. (2026). Trust the messenger, then the message: Unpacking the cross-route logic of danmaku engagement. *Aslib Journal of Information Management*, 1-26. [https://doi.org/10.1108/AJIM-01-2026-0111](https://doi.org/10.1108/AJIM-01-2026-0111)
- Yu, T., Teoh, A. P., Tu, Q. Y., & **Wang, C. L.** (2026). Quality, norms and privacy in AI chatbot adoption: A multigroup analysis. *International Journal of Contemporary Hospitality Management, 38*(5), 1701-1724. [https://doi.org/10.1108/IJCHM-08-2025-1167](https://doi.org/10.1108/IJCHM-08-2025-1167)
- Yu, T., Teoh, A. P., Liao, J. Y., & **Wang, C. L.** (2026). What drives the continuance intention of service robots in the hospitality industry? An integrated model of motivated consumer innovativeness and extended technology continuance theory. *Journal of Hospitality Marketing & Management, 35*(4), 608-653. [https://doi.org/10.1080/19368623.2026.2616771](https://doi.org/10.1080/19368623.2026.2616771)
...
- Xu, J., Luo, Y., **Wang, C. L.**, Wang, M., & Wu, Y. (2026). AI support in self-regulated learning: A decade of technological evolution and meta-analysis. *British Journal of Educational Technology, 57*(5), 1191-1220. [https://doi.org/10.1111/bjet.70058](https://doi.org/10.1111/bjet.70058) (SSCI Q1)
...
- Yu, T., Teoh, A. P., **Wang, C. L.**, & Bian, Q. (2024). Convenient or risky? Investigating the behavioral intention to use facial recognition payment in smart hospitals. *Humanities and Social Sciences Communications*, 11(1), 1592. [https://doi.org/10.1057/s41599-024-03910-9](https://doi.org/10.1057/s41599-024-03910-9) (SSCI Q1; AHCI)
- Yu, T., Teoh, A.P., Bian, Q., Liao, J. & **Wang, C. L.** (2024b). Can virtual influencers affect purchase intentions in tourism and hospitality e-commerce live streaming? An empirical study in China. *International Journal of Contemporary Hospitality Management*, 1-23. [https://doi.org/10.1108/IJCHM-03-2024-0358](https://doi.org/10.1108/IJCHM-03-2024-0358) (SSCI Q1; AJG 3)
...
- Pian, Y.\*, Yang, F., Di, Z. F., & **Wang, C. L.** (2026). "My culture is as good as yours": Designing an AI agent to support intercultural understanding in rural EFL classrooms. In E. G. Blanchard, G. Chen, M. Chi, & S. Isotani (Eds.), *Artificial Intelligence in Education. Late Breaking Results, WideAIED, Practitioners, Industry and Policies, Blue Sky, Doctoral Consortium, FoL Workshops and Tutorials, FoL Invited Papers* (Communications in Computer and Information Science, Vol. 3032, pp. 308-318). Springer Nature Switzerland. [https://doi.org/10.1007/978-3-032-29791-4_24](https://doi.org/10.1007/978-3-032-29791-4_24)
...
<summary>Quasi-Experimental and Experimental Studies <span class="method-count">8 studies</span></summary>
...
<details class="method-group" markdown="1">
<summary>Bibliometric Analysis <span class="method-count">12 studies</span></summary>
...
<details class="method-group" markdown="1">
<summary>Structural Equation Modeling <span class="method-count">23 studies</span></summary>
...
<details class="method-group" markdown="1">
<summary>Systematic Literature Review <span class="method-count">7 studies</span></summary>
...
- Xu, J., Luo, Y., **Wang, C. L.**, Wang, M., & Wu, Y. (2026). AI support in self-regulated learning: A decade of technological evolution and meta-analysis. *British Journal of Educational Technology, 57*(5), 1191-1220. [https://doi.org/10.1111/bjet.70058](https://doi.org/10.1111/bjet.70058)
...
<details class="method-group" markdown="1">
<summary>fsQCA <span class="method-count">5 studies</span></summary>
